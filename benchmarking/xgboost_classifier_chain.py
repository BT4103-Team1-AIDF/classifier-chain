...
DEFAULT_RESULTS_PATH = str(PROJECT_ROOT / "outputs" / "xgboost_classifier_chain_probabilities.csv")
RANDOM_STATE = 42
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train and evaluate the XGBoost classifier chain.")
